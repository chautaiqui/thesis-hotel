...
export const Home = () => {
  ...
  return (
    <div>
      <Divider orientation="left" plain><h1>Welcome to Hotel</h1></Divider>
      <div className='br-homepage'>
        <div className="on-form">
          <Form 
            onFinish={onFinish} className="form-search" 
          >
            <Row gutter={[16,16]}
            style={{
              background:' #fff',
            ...
            >
              ...
              <Col xs={24} sm={24} md={8} lg={8} xl={8} style={{display: 'flex', justifyContent: 'center'}}>
                <Form.Item className="search-btn">
                  <Button type="primary" htmlType="submit" shape="round" icon={<SearchOutlined />}></Button>
                </Form.Item>
              </Col>
            </Row>
          </Form>
      ...
      <Divider orientation="left" plain><h1>Explore</h1></Divider>
      <CarouselCus search={search}/>
      <Divider orientation="left" plain><h1>Blog</h1></Divider>
