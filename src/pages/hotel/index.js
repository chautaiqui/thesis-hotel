...
const url = 'https://res.cloudinary.com/hotellv/image/upload/v1621233855/tmsvnhfbf7vcmks132jy.jpg';
export const Hotel = () => {
  var location = useLocation();
	const history = useHistory();
  const [ lstHotel, setLstHotel ] = useState([]);
  var param = location.search.slice(1).split('&').reduce((r, i) => Object.assign({}, r, { [i.split('=')[0]]: i.split('=')[1] }), {});
  ...
  return (
    ...
    <Select 
      placeholder="Sort"
      options={[{label: 'Price: Low to High', value: 'low'}, {label: 'Price: High to Low', value: 'high'}]}
