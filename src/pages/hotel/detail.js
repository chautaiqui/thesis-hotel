      ...
      query.get('id') ? (<div>
        ...
        <div style={{marginTop:20}}>
          ...
          <div className='detail-decr'>
            <img src="https://res.cloudinary.com/fpt-telecom/image/upload/v1621972432/ife6wabz6l5jrzqoagby.png" alt='lct'/>
            <p>{`${hotel.street} ${hotel.ward} ${hotel.district} ${hotel.province}`}</p>
            <div className="view-map">View map</div>
          </div>
          <div>
            <h3 style={{fontWeight: 'bolder', textAlign: 'start', marginTop: 10}}>Facilities</h3>
          </div>
        </div>
