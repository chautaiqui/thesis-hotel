...
export const Signup = () => {
  ...
  return (
    <div>
      <Row style={{ height: 200, background: '#3390FF', justifyContent: 'center'}} gutter={[16,16]}>
      ...
      <Row gutter={[16,16]} style={{marginTop: 10}}>
        ...
        <Col xs={24} sm={24} md={12} lg={12} xl={12}>
          <Card className={'height-50 card'} title="Register" bordered={false} style={{ width: '100%', borderRadius: 15, boxShadow: 'rgb(0 0 0 / 12%) 0px 2px 10px' }}>
            <Form
              name="normal_login"
